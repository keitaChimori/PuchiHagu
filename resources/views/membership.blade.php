...
<!-- ページタイトル -->
@section('title','利用規約 ｜ 幼児無料プリントサイト ぷちはぐ')
...
<div id="contents">
    <section class="box1">
        ...
        <div id="contents">
            ...
            <p>ユーザーID及びパスワードが第三者によって使用されたことによって生じた損害は，当社に故意又は重大な過失がある場合を除き，当社は一切の責任を負わないものとします。</p>
            <h3>第5条（禁止事項）</h3>
            ...
            <p>当社，ほかのユーザー，またはその他第三者のサーバーまたはネットワークの機能を破壊したり，妨害したりする行為</p>
            ...
            <p>他のユーザーに成りすます行為</p>
            <p>当社が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為</p>
            ...
            <p>その他，当社が本サービスの利用を適当でないと判断した場合</p>
